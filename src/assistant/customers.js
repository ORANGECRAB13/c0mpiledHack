...
export const CUSTOMERS = [
  {
    ...
    workflow: 'Payment Difficulty Review', priority: 'High', status: 'Ready for review', action: 'Assess support eligibility',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Best Offer Review', priority: 'Medium', status: 'Evidence assembling', action: 'Confirm tariff comparison',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Payment Difficulty Review', priority: 'High', status: 'Ready for review', action: 'Contact before determination',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Revenue Assurance', priority: 'Medium', status: 'Exception found', action: 'Verify meter read history',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Unknown Consumer', priority: 'Medium', status: 'Investigation open', action: 'Confirm occupancy',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Payment Difficulty Review', priority: 'Low', status: 'Monitoring', action: 'Reassess support level',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Onboarding Validation', priority: 'Medium', status: 'Data issue', action: 'Resolve ABN mismatch',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Best Offer Review', priority: 'Low', status: 'Ready for review', action: 'Approve plan switch',
    facts: [
      'Best offer comparison complete on 12 months of interval data; $9/month saving identified.',
      'Explicit informed consent recorded via SMS link 30 Jul — switch is ready to action at no charge from the next billing cycle.',
  ...
  },
  {
    ...
    workflow: 'Revenue Assurance', priority: 'High', status: 'Exception found', action: 'Review unbilled period',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Payment Difficulty Review', priority: 'Medium', status: 'Evidence assembling', action: 'Await CRM sync',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Onboarding Validation', priority: 'Low', status: 'Data issue', action: 'Confirm concession card',
    facts: [
  ...
  },
  {
    ...
    workflow: 'Best Offer Review', priority: 'Medium', status: 'Ready for review', action: 'Confirm consent to switch',
    facts: [
      'Best offer comparison complete; $11/month saving identified using 12 months of interval data.',
...
/** Customer records rendered for the system prompt. */
export function customersPrompt() {
