...
export async function readSalesforceCustomer(externalCustomerId) {
  ...
  const fields = ['Id','Name','BillingState','LastModifiedDate','External_Customer_Id__c','Balance__c','Oldest_Debt_Days__c','Hardship_Status__c','Hardship_Review_Due_At__c','Financial_Stress_Signal__c','Missed_Payments_90d__c','Partial_Payments_90d__c','Current_Plan__c','Best_Offer_Opt_Out__c','Sensitive_Customer__c'];
